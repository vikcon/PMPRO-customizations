...
function my_pmpro_init_require_tos_link_to_media() {
	...
	$tos_link = "#"; // Set your media file ID here.
	$prvc_link = "#"; // Set your media file ID here.

	// Create label that displays a link to the Terms & Conditions.
	$label = 'I agree to the <a href="' . $tos_link . '" target="_blank" id="my-pmpro-require-tos-link" class="my-pmpro-require-tos-link">Terms & Conditions</a> & ' .  '<a href="' . $prvc_link . '" target="_blank" id="my-pmpro-require-privacy-link" class="my-pmpro-require-prvc-link">Privacy</a>';
